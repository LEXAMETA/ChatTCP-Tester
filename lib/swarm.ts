...
export const mockPeers: Peer[] = [
  { ip: '192.168.49.2', port: 8080, model: 'qwen3', loras: ['math_specialist', 'code_expert'], load: 0.2, lastSeen: Date.now() },
  { ip: '192.168.49.3', port: 8080, model: 'osmosis', loras: ['creative_writer'], load: 0.5, lastSeen: Date.now() - 30000 }, // 30s ago
  { ip: '192.168.49.4', port: 8080, model: 'qwen3', loras: [], load: 0.1, lastSeen: Date.now() },
  { ip: '192.168.49.5', port: 8080, model: 'llama3', loras: ['dutch_translator'], load: 0.8, lastSeen: Date.now() - 60000 }, // 1min ago
];
